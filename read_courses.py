...
full_time_instructors = Instructor.objects.exclude(full_time=False).filter(total_learners__gt=30000).filter(first_name__startswith='Y')
...
# Another way to find all full-time instructors with First Name starts with 'Y' and learners count greater than 30000
