...
# Filter all part-time instructors
...
# Filter full-time instructors with certain conditions
...
print("4. Find all full-time instructors with First Name starting with `Y` and learner count greater than 30000")
print(full_time_instructors)
print("\n")

# Another way to filter full-time instructors with the same conditions
full_time_instructors = Instructor.objects.filter(full_time=True, total_learners__gt=30000,
                                                  first_name__startswith='Y')
print("5. Find all full-time instructors with First Name starting with `Y` and learner count greater than 30000")
print(full_time_instructors)
